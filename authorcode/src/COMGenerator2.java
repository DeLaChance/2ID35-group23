 ...
 * 该类用以生成COM文件
 */
public class COMGenerator2 extends VectorLabeledGraph5{
	...
	public COMGenerator2(File xmlFile) {
	...
	public void merge(int start_of_third, int scaningfactor, int node_id_to_get_COM){
		
		long time1 = System.currentTimeMillis();
			
		System.out.println(input_graph.length);
		
		for(int i=start_of_third; i<input_graph.length-1; i++){
	...
	public static void main(String[] args){
		...
		COMGenerator2 g = new COMGenerator2(xmlFile);
		//g.merge(301231,20,301235);
		g.merge(start_of_third, scaningfactor, pos_to_trivial_COM);
