...
public class VectorLabeledGraph5 extends DAG2{
	...
	public VectorLabeledGraph5(File xmlFile){
		super(xmlFile);
		stk3 = new ArrayList();
	...
	public static void main(String args[]){
	    ...
	    VectorLabeledGraph5 g = new VectorLabeledGraph5(xmlFile);
	    ...
	    System.out.println(DataVertex.labelToVertexIDMap.get("open_auction").size());
	    System.out.println(DataVertex.labelToVertexIDMap.get("bidder").size());
	}
